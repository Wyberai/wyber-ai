...
export function CommandPalette() {
  ...
  const items: CommandItem[] = [
    ...
    { id: 'new-workflow', label: 'New workflow', desc: 'Visual automation builder', icon: '⚡', category: 'Build', action: () => nav('/flows'), keywords: ['automation', 'flow'] },
    { id: 'new-agent', label: 'New AI agent', desc: 'Canvas-based agent builder', icon: '🤖', category: 'Build', action: () => nav('/agents'), keywords: ['bot', 'autonomous'] },
    { id: 'new-employee', label: 'Hire AI employee', desc: 'Browse 100 roles', icon: '💼', category: 'Build', action: () => nav('/ai-employees/new'), keywords: ['hire', 'sdr', 'analyst'] },
    { id: 'new-campaign', label: 'New GTM campaign', desc: 'Outreach sequence builder', icon: '🎯', category: 'Build', action: () => nav('/gtm/campaigns/new'), keywords: ['outreach', 'email', 'leads'] },

    // Navigate
    { id: 'dashboard', label: 'Dashboard', icon: '🏠', category: 'Navigate', action: () => nav('/dashboard') },
    { id: 'templates', label: 'Template gallery', desc: '500+ prebuilt apps', icon: '📦', category: 'Navigate', action: () => nav('/templates'), keywords: ['gallery', 'prebuilt'] },
    { id: 'mobile-templates', label: 'Mobile templates', icon: '📱', category: 'Navigate', action: () => nav('/templates/mobile') },
    { id: 'employees', label: 'AI Employees', icon: '👥', category: 'Navigate', action: () => nav('/ai-employees') },
    { id: 'flows', label: 'Workflows', icon: '⚡', category: 'Navigate', action: () => nav('/flows') },
    { id: 'gtm', label: 'GTM Engine', icon: '🎯', category: 'Navigate', action: () => nav('/gtm') },
    { id: 'leads', label: 'GTM Leads', icon: '👤', category: 'Navigate', action: () => nav('/gtm/leads') },
    { id: 'sequences', label: 'GTM Sequences', icon: '📧', category: 'Navigate', action: () => nav('/gtm/sequences') },
    { id: 'settings', label: 'Settings', icon: '⚙️', category: 'Navigate', action: () => nav('/settings') },
    { id: 'api-keys', label: 'API Keys', icon: '🔑', category: 'Navigate', action: () => nav('/api-keys') },
    { id: 'learn', label: 'Learn', desc: '6 guided tracks', icon: '📚', category: 'Navigate', action: () => nav('/learn'), keywords: ['tutorial', 'guide'] },
    { id: 'docs', label: 'Documentation', icon: '📖', category: 'Navigate', action: () => nav('/docs') },
