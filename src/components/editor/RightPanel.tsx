...
type Tab = 'chat' | 'agent' | 'figma' | 'knowledge' | 'templates' | 'database' | 'security' | 'themes' | 'suggestions' | 'images' | 'connectors' | 'history' | 'github' | 'cloud' | 'payments' | 'seo' | 'analytics' | 'feedback';
