...
export default function App() {
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', fontFamily: 'system-ui', gap: 16 }}>
      <h1 style={{ fontSize: 32, fontWeight: 700 }}>Hello from Forge ⚡</h1>
    ...
    'package.json': f('package.json', `
{
  ...
  "devDependencies": {
    ...
    'vite.config.ts': f('vite.config.ts', `
...
<html lang="en">
  ...
  <body>
    ...
    'src/main.js': f('src/main.js', `
import { createApp } from 'vue';
import App from './App.vue';
createApp(App).mount('#app');`),
    'src/App.vue': f('src/App.vue', `
<template>
  <div class="app">
...
export default function Home() {
  ...
  return (
    ...
    'app/layout.tsx': f('app/layout.tsx', `
