            ...
            <main className="flex-1 min-w-0">
              ...
              <div className="p-5 sm:p-8 space-y-6">
                ...
                <div className="rounded-xl border border-primary/20 bg-gradient-to-br from-primary/10 to-transparent p-6 sm:p-8 text-center">
                  ...
                  <p className="mx-auto mt-2 max-w-xl text-sm text-muted-foreground">Sign up and build this exact AI-native seller dashboard in your own WyberAi project — ready to customize. Connect your marketplace accounts and AI key and it runs on your real numbers. Starts at just <span className="text-foreground font-medium">30 free credits</span>.</p>
                  <a href="https://wyberai.com/signup" className="mt-5 inline-flex items-center gap-2 rounded-md bg-primary px-5 py-2.5 text-sm font-medium text-primary-foreground hover:opacity-90 transition-opacity"><ChevronRight className="h-4 w-4" /> Start building free — 30 credits</a>
