...
const THEME_EXTEND = `{
      ...
      keyframes: {
        ...
        'drift': { '0%': { transform: 'translate(0,0) scale(1)' }, '33%': { transform: 'translate(3%,-4%) scale(1.08)' }, '66%': { transform: 'translate(-4%,3%) scale(0.95)' }, '100%': { transform: 'translate(0,0) scale(1)' } },
        'twinkle': { '0%,100%': { opacity: '0.15' }, '50%': { opacity: '1' } },
        'blob-morph': { '0%': { borderRadius: '42% 58% 65% 35% / 45% 45% 55% 55%', transform: 'rotate(0deg) scale(1)' }, '25%': { borderRadius: '60% 40% 30% 70% / 55% 65% 35% 45%', transform: 'rotate(8deg) scale(1.04)' }, '50%': { borderRadius: '35% 65% 55% 45% / 40% 30% 70% 60%', transform: 'rotate(-6deg) scale(0.97)' }, '75%': { borderRadius: '55% 45% 40% 60% / 65% 55% 45% 35%', transform: 'rotate(4deg) scale(1.02)' }, '100%': { borderRadius: '42% 58% 65% 35% / 45% 45% 55% 55%', transform: 'rotate(0deg) scale(1)' } },
        'grid-pan': { '0%': { backgroundPosition: '0px 0px' }, '100%': { backgroundPosition: '120px 120px' } },
        'stripe-pan': { '0%': { backgroundPosition: '0px 0px' }, '100%': { backgroundPosition: '200px 0px' } },
        'wave-drift': { '0%': { transform: 'translateX(0%)' }, '50%': { transform: 'translateX(-3%)' }, '100%': { transform: 'translateX(0%)' } },
        'float-orb': { '0%': { transform: 'translateY(0)' }, '50%': { transform: 'translateY(calc(var(--float-distance, 16px) * -1))' }, '100%': { transform: 'translateY(0)' } },
        'gradient-move': { '0%': { backgroundPosition: '0% 50%' }, '100%': { backgroundPosition: '200% 50%' } },
      ...
      animation: {
        ...
        'stripe-pan': 'stripe-pan 20s linear infinite',
        'wave-drift': 'wave-drift 30s ease-in-out infinite',
