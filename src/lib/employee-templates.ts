// Static canonical data for the 100 Enterprise AI Employee role templates.
// The gallery page uses this directly — no DB query needed for the catalog.
// Only user-hired employees (in ai_employees table) need Supabase.
...
// [name, emoji, dept, tagline, vdb, code, tool, popular]
...
const ROWS: Row[] = [
  ...
  // ── Category 3: Specialized Infrastructure & Security ─────────────────────
  ...
  // ── Category 4: Core Engineering & Software Architecture ──────────────────
  ...
  // ── Category 5: Commercial Sales & Expansion Engineering ──────────────────
  ...
  // ── Category 6: E-Commerce & Retail Mechanics ─────────────────────────────
  ...
  // ── Category 7: Customer Experience & Feedback Systems ───────────────────
  ...
  // ── Category 8: HR Infrastructure & Workplace Performance ────────────────
  ...
  // ── Category 9: Supply Chain & Global Trade Logistics ─────────────────────
  ...
  // ── Category 10: Legal, Governance & Risk ─────────────────────────────────
...
export const EMPLOYEE_TEMPLATES: EmployeeTemplate[] = ROWS.map(([name, emoji, department, tagline, vector_db_scope, guardrail_code, primary_tool, popular]) => ({
  slug: slug(name),
  name,
  emoji,
  department,
