...
export const PAPER_LEAK_INCIDENTS: PaperLeakIncident[] = [
  ...
  },
  {
    ...
    sources: [
      ...
      { title: '2024 NEET controversy', url: 'https://en.wikipedia.org/wiki/2024_NEET_controversy', outlet: 'Wikipedia' },
  ...
  {
    id: 'neet-ug-2026',
    examName: 'NEET-UG (National Eligibility cum Entrance Test) 2026',
    year: 2026,
    state: 'National',
    category: 'Medical Entrance',
    conductingBody: 'National Testing Agency (NTA)',
    summary: 'The exam, held May 3, 2026 for over 2.27 million candidates, was cancelled nine days later after investigators found a pre-circulated "guess paper" overlapped with 120–140 questions from the actual exam — flagged after a chemistry teacher in Sikar, Rajasthan compared the leaked material to the real paper.',
    outcome: "The CBI arrested a Pune school headmistress who had been appointed an NTA subject expert, accusing her of leaking physics questions from memory. The probe also uncovered a paid WhatsApp network — described in reporting as a ‘Private Mafia’ group — charging roughly ₹5,000 for partial question access and ₹10–25 lakh for the full paper. A medical-association petition asked the Supreme Court to overhaul the NTA and order a court-supervised re-exam; NTA filed an affidavit outlining security reforms, and a re-exam (RE-NEET 2026) was scheduled for June 21, 2026.",
    status: 'court_case_ongoing',
    impact: 'The anger from this leak fed into a broader nationwide protest movement over exam integrity that was still active in July 2026: reporting from that period documents more than 20 suicides nationally linked to exam-fraud grievances and more than 100 people injured when police used tear gas and batons against demonstrators marching in Delhi. If you or someone you know is struggling, India’s KIRAN mental health helpline is available 24/7 at 1800-599-0019.',
    sources: [
      { title: '2026 NEET controversy', url: 'https://en.wikipedia.org/wiki/2026_NEET_controversy', outlet: 'Wikipedia' },
      { title: "NEET UG 2026 Paper Leak Scandal Deepens: CBI Arrests MBBS Students, Doctors in 'Private Mafia' WhatsApp Network", url: 'https://www.medboundtimes.com/daily-pulse/neet-ug-2026-paper-leak-cbi-arrests-timeline', outlet: 'Medbound Times' },
      { title: 'NEET UGC 2026 leak: Petition filed to replace NTA, conduct re-exam under Supreme Court supervision', url: 'https://www.barandbench.com/news/litigation/neet-ugc-2026-leak-petition-filed-to-replace-nta-conduct-re-exam-under-supreme-court-supervision', outlet: 'Bar and Bench' },
