...
export const metadata: Metadata = {
  ...
  title: { default: 'WyberAi — Six pillars: web apps, mobile apps, AI agents, workflows, AI employees & GTM', template: '%s | WyberAi' },
  ...
  openGraph: {
    ...
    siteName: 'WyberAi',
    title: 'WyberAi — Six pillars: web apps, mobile apps, AI agents, workflows, AI employees & GTM',
    description: 'One platform, one prompt, no code. Build web apps, mobile apps, AI agents, and workflow automations — then hire AI employees and launch GTM campaigns that fill your pipeline.',
    images: [{ url: '/api/og?title=Six%20Pillars%2C%20One%20Platform&sub=Web%2C%20Mobile%2C%20Agents%2C%20Workflows%2C%20AI%20Employees%2C%20GTM', width: 1200, height: 630, alt: 'WyberAi' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'WyberAi — Six pillars: web apps, mobile apps, AI agents, workflows, AI employees & GTM',
    description: 'One platform, one prompt, no code. Build web apps, mobile apps, AI agents, and workflow automations — then hire AI employees and launch GTM campaigns that fill your pipeline.',
    images: ['/api/og?title=Six%20Pillars%2C%20One%20Platform&sub=Web%2C%20Mobile%2C%20Agents%2C%20Workflows%2C%20AI%20Employees%2C%20GTM'],
  },
