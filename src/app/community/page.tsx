...
const CHANNELS = [
  { icon: '💬', name: 'Discord', desc: 'Real-time help, share what you\'re building, connect with other builders.', cta: 'Join Discord', href: 'https://discord.gg/A5KsFv2P', color: '#5865F2' },
