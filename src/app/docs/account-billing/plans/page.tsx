...
export default function Page() {
  return (
    <DocsPage
      ...
      title="Plans & pricing"
      intro="WyberAi offers a free tier and paid plans. All plans include the web and mobile app builders, with AI agents, workflows, AI employees, and the GTM engine included as they roll out of early access."
    >
          ...
          {[
            {
              ...
              items: ['150 monthly credits', 'All 6 products', 'Unlimited projects', 'Email support'],
            },
            {
              name: 'Builder',
              price: '$79',
              ...
              items: ['500 monthly credits', 'All 6 products', 'Unlimited projects', 'Email support'],
            },
            {
              name: 'Pro',
              price: '$199',
