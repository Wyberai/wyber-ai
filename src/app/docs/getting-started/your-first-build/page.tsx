        ...
        <Steps>
          ...
          <Step n={3} title="Describe your app">
            ...
            <p style={{ fontSize: 14, color: 'rgba(255,255,255,0.7)', lineHeight: 1.7, marginTop: 8 }}>
              A credit estimate is shown before you generate — 1 credit for a standard web app. Click <strong>Generate</strong> when you're ready.
            </p>
          ...
          <Step n={5} title="Preview and iterate">
            <p style={{ fontSize: 14, color: 'rgba(255,255,255,0.7)', lineHeight: 1.7 }}>
              Once generation is complete, click any element in the preview to select it and describe a change — this uses <strong>click-to-edit</strong> mode. Or type a follow-up prompt in the chat panel to change a whole section. Each iteration costs 1 credit and is non-destructive — you can always go back to the previous version.
            </p>
