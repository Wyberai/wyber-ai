...
const TOPUPS = [
  { credits: 40,  price: 19,  priceINR: 399,  key: 'topup_200',  label: 'Boost',  descKey: 'topupDescBoost' },
  { credits: 100, price: 49,  priceINR: 999,  key: 'topup_600',  label: 'Power',  descKey: 'topupDescPower' },
  { credits: 200, price: 99,  priceINR: 1999, key: 'topup_2000', label: 'Studio', descKey: 'topupDescStudio', hasBadge: true },
]
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--brand-bg)', color: '#fafafa', fontFamily: 'var(--font-display)' }}>
      ...
      <section style={{ padding: 'clamp(60px,8vw,100px) clamp(16px,4vw,48px) 0', textAlign: 'center' }}>
        ...
        <h1 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(32px,5vw,64px)', fontWeight: 800, letterSpacing: '-0.04em', lineHeight: 1.05, marginTop: 24, marginBottom: 16 }}>
          {t('heroTitleLine1')}<br />
        ...
        <div style={{ maxWidth: 900, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 36 }}>
            ...
            <p style={{ fontSize: 15, color: '#71717a', maxWidth: 480, margin: '0 auto' }}>
              Prefer to hand it off? Book a free scoping call — no charge, just a real conversation about your idea.
            </p>
          </div>
