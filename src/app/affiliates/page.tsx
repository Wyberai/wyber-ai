...
export const metadata: Metadata = { title: 'Affiliates — Wyber AI', description: 'Earn 30% recurring commission for every customer you refer to Wyber AI.' };
const STEPS = [
  ...
  return (
    <div style={{ minHeight:'100vh', background:'var(--bg)', fontFamily:'var(--font-sans)' }}>
      ...
      <div className="wy-section">
        ...
        <p style={{ fontSize:17, color:'var(--text2)', maxWidth:520, lineHeight:1.75, marginBottom:40 }}>Refer developers and founders to Wyber AI. Earn 30% commission on every payment — forever, not just the first month.</p>
        ...
        <a href="mailto:affiliates@wyberai.com?subject=Wyber AI Affiliate Application" className="wy-btn-primary" style={{ display:'inline-flex' }}>Apply via email →</a>
