...
export default function EmployeeDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (loading) return (
    <div style={{ minHeight: '100vh', background: '#0b0d12', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#3f3f46', fontFamily: 'var(--font-display)' }}>Loading…</div>
  )
  if (!employee) return (
    <div style={{ minHeight: '100vh', background: '#0b0d12', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 16, fontFamily: 'var(--font-display)', color: '#52525b' }}>
