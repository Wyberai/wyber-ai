...
export const metadata: Metadata = {
  title: 'About Ã¢â‚¬â€ Wyber AI',
  description: 'Wyber AI is built by SignalPulse Technologies. We build tools that help founders ship faster.',
};

const PRODUCTS = [
  { name: 'Wyber AI', desc: 'AI-powered app builder. Turn ideas into live apps.', url: 'https://wyberai.com', icon: 'Ã¢Å¡Â¡' },
  { name: 'Recon Signal', desc: 'Executive intelligence platform for B2B leaders.', url: 'https://reconsignal.com', icon: 'Ã¢â€”Å½' },
  { name: 'Setu Agents', desc: 'AI agents for business automation.', url: 'https://setuagents.com', icon: 'Ã¢â€”Ë†' },
  { name: 'Continuum API', desc: 'Email validation and enrichment API.', url: 'https://continuumapi.com', icon: 'Ã¢Â¬Â¡' },
];
    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg)', fontFamily: 'var(--font-sans)' }}>
      ...
      <div style={{ maxWidth: 800, margin: '0 auto', padding: 'clamp(64px,10vw,100px) clamp(16px,4vw,40px) 0' }}>
        ...
        <p style={{ fontSize: 18, color: 'var(--text2)', lineHeight: 1.7, maxWidth: 600, margin: 0 }}>
          Wyber AI is a product of SignalPulse Technologies Ã¢â‚¬â€ a focused software company building AI-powered tools for founders, marketers, and developers.
        </p>
      </div>
      <div style={{ maxWidth: 800, margin: '0 auto', padding: 'clamp(48px,6vw,72px) clamp(16px,4vw,40px)' }}>
        <div style={{ background: 'var(--bg2)', border: '1px solid var(--border)', borderRadius: 20, padding: 'clamp(32px,5vw,48px)', marginBottom: 48 }}>
          ...
          <p style={{ fontFamily: 'var(--font-serif)', fontSize: 'clamp(20px,3vw,28px)', fontWeight: 400, color: 'var(--text)', lineHeight: 1.5, margin: '0 0 20px', letterSpacing: '-0.02em' }}>
            "The best ideas never get built because technical barriers get in the way. We are removing those barriers Ã¢â‚¬â€ one product at a time."
          </p>
          <p style={{ fontSize: 14, color: 'var(--text3)', margin: 0 }}>Ã¢â‚¬â€ Sumeet Sutar, Founder Ã‚Â· SignalPulse Technologies</p>
        </div>
        <div style={{ background: 'var(--card)', border: '1px solid var(--border)', borderRadius: 16, padding: 28, boxShadow: 'var(--shadow)', marginBottom: 48, display: 'flex', gap: 24, alignItems: 'flex-start' }}>
          ...
          <div>
            ...
            <p style={{ fontSize: 14, color: 'var(--text2)', lineHeight: 1.65, margin: 0 }}>9 years in B2B marketing across Cybersecurity, Cloud Infrastructure, and SaaS. Previously at Dell Technologies, Happiest Minds, and Netenrich. Building the SignalPulse product family.</p>
          </div>
        </div>
        ...
        <div style={{ textAlign: 'center', padding: '40px 0' }}>
          ...
          <p style={{ fontSize: 15, color: 'var(--text2)', marginBottom: 24 }}>Questions, feedback, partnerships Ã¢â‚¬â€ we read every email.</p>
          ...
          <p style={{ fontSize: 13, color: 'var(--text3)', marginTop: 20 }}>
            SignalPulse Technologies Ã‚Â· Wyoming, USA Ã‚Â· <a href="https://signalpulsehq.com" target="_blank" rel="noreferrer" style={{ color: 'var(--sky)' }}>signalpulsehq.com</a>
          </p>
        </div>
      </div>
      <Footer />
