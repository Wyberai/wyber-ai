...
export default function StatusPage() {
  const services = [
    { name: 'AI Generation', status: 'operational', latency: '1.2s avg', icon: '⚡' },
    { name: 'Live Preview', status: 'operational', latency: '28s cold start', icon: '◎' },
    { name: 'Authentication', status: 'operational', latency: '<100ms', icon: '🔒' },
    { name: 'Database', status: 'operational', latency: '<50ms', icon: '🗄' },
    { name: 'Deployment', status: 'operational', latency: '30s avg', icon: '↥' },
    { name: 'Email', status: 'operational', latency: '<5s', icon: '✉' },
  ];
