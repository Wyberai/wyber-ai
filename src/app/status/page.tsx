...
export default function StatusPage() {
  const services = [
    { name: 'AI Generation', status: 'operational', latency: '1.2s avg', icon: 'Ã¢Å¡Â¡' },
    { name: 'Live Preview', status: 'operational', latency: '28s cold start', icon: 'Ã¢â€”Å½' },
    { name: 'Authentication', status: 'operational', latency: '<100ms', icon: 'Ã°Å¸â€â€™' },
    { name: 'Database', status: 'operational', latency: '<50ms', icon: 'Ã°Å¸â€”â€ž' },
    { name: 'Deployment', status: 'operational', latency: '30s avg', icon: 'Ã¢â€ Â¥' },
    { name: 'Email', status: 'operational', latency: '<5s', icon: 'Ã¢Å“â€°' },
  ];
