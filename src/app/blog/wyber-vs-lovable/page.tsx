    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg)', fontFamily: 'var(--font-sans)' }}>
      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: 'clamp(40px,6vw,72px) clamp(16px,4vw,40px)' }}>
        ...
        <div className="wy-prose">
          ...
          <p><strong>Free AI error fixes.</strong> In Lovable, every generation costs credits -- including AI mistakes. In Wyber AI, fixing errors is always free.</p>
          ...
          <p><strong>Visual editor.</strong> Click any element to edit without prompting. Wyber AI does not have this yet.</p>
          <p><strong>Enterprise maturity.</strong> SOC2 Type II, ISO 27001, SSO, SCIM. More mature for large organizations.</p>
          <h2>The bottom line</h2>
          <p>Choose Lovable if you want the most mature tool with the largest community. Choose Wyber AI if you want framework flexibility, free error fixes, and lower pricing.</p>
