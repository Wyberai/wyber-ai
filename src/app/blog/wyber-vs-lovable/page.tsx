...
export const metadata: Metadata = {
  title: 'Wyber AI vs Lovable: Which AI app builder is right for you? — Wyber AI Blog',
...
const COMPARISON = [
  ...
  { feature: 'SSR by default', wyber: '✓ Next.js default', lovable: '✓ TanStack Start' },
  ...
  { feature: 'MCP server', wyber: '✓ wyberai.com/api/mcp', lovable: '✓ mcp.lovable.dev' },
  { feature: 'Figma import', wyber: '✓', lovable: '✓' },
  { feature: 'Visual editor', wyber: 'Coming soon', lovable: '✓' },
  { feature: 'Community', wyber: 'Early stage', lovable: '160K+ Discord members' },
  { feature: 'SOC2', wyber: 'In progress', lovable: '✓ Type II' },
];
    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg)', fontFamily: 'var(--font-sans)' }}>
      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: 'clamp(40px,6vw,72px) clamp(16px,4vw,40px)' }}>
        ...
        <div className="wy-prose">
          <p>Lovable is the market leader in AI app builders — 2.3 million users, $330M raised, 160,000-member Discord. Wyber AI is newer, smaller, and built for a different kind of builder. This is an honest comparison, written by the Wyber AI team.</p>
        ...
        <div className="wy-prose">
          ...
          <p><strong>Free AI error fixes.</strong> In Lovable, every generation costs credits — including AI mistakes. In Wyber AI, if the AI gets something wrong, fixing it is always free.</p>
          <p><strong>Price.</strong> Wyber AI Starter is $15/month vs Lovable's $25/month for a comparable tier.</p>

          <h2>Where Lovable wins</h2>
          <p><strong>Community.</strong> 160K Discord members. If you want to learn alongside other builders, Lovable's community is unmatched right now.</p>
          <p><strong>Visual editor.</strong> Click any element to edit without prompting. Wyber AI doesn't have this yet.</p>
          <p><strong>Enterprise maturity.</strong> SOC2 Type II, ISO 27001, SSO, SCIM. Lovable is more mature for large organizations.</p>
