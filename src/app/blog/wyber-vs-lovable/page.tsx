    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg)', fontFamily: 'var(--font-sans)' }}>
      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: 'clamp(40px,6vw,72px) clamp(16px,4vw,40px)' }}>
        ...
        <div className="wy-prose">
          ...
          <p><strong>Scope.</strong> WyberAi builds both web and native mobile apps vs Lovable's web-only builder — with AI agents, workflows, AI employees, and a GTM engine rolling out in early access on top.</p>
