    ...
    <div style={{ minHeight: '100vh', background: s.bg, color: s.text, fontFamily: "'Space Grotesk', sans-serif" }}>
      ...
      <article style={{ maxWidth: 680, margin: '0 auto', padding: 'clamp(40px,6vw,80px) clamp(16px,4vw,48px)' }}>
        ...
        <div style={{ fontSize: 16, color: s.muted, lineHeight: 1.75 }}>
          ...
          <h2 style={{ fontFamily: "'Sora', sans-serif", fontSize: 22, fontWeight: 800, letterSpacing: '-0.03em', color: s.text, margin: '36px 0 14px' }}>The hidden cost of spreadsheet-based operations</h2>
          ...
          <h2 style={{ fontFamily: "'Sora', sans-serif", fontSize: 22, fontWeight: 800, letterSpacing: '-0.03em', color: s.text, margin: '36px 0 14px' }}>What AI builders change</h2>
          ...
          <h2 style={{ fontFamily: "'Sora', sans-serif", fontSize: 22, fontWeight: 800, letterSpacing: '-0.03em', color: s.text, margin: '36px 0 14px' }}>Example prompts that work</h2>
          ...
          <div style={{ background: s.card, borderRadius: 10, padding: '16px 20px', border: `1px solid ${s.border}`, fontFamily: 'monospace', fontSize: 13, color: '#e2e8f0', lineHeight: 1.8, margin: '16px 0' }}>
            <div style={{ marginBottom: 16 }}>
              <div style={{ color: s.sky, fontFamily: "'Space Grotesk', sans-serif", fontSize: 12, fontWeight: 700, marginBottom: 4 }}>ADMIN PANEL</div>
            ...
            <div style={{ marginBottom: 16 }}>
              <div style={{ color: s.sky, fontFamily: "'Space Grotesk', sans-serif", fontSize: 12, fontWeight: 700, marginBottom: 4 }}>APPROVAL WORKFLOW</div>
            ...
            <div style={{ marginBottom: 16 }}>
              <div style={{ color: s.sky, fontFamily: "'Space Grotesk', sans-serif", fontSize: 12, fontWeight: 700, marginBottom: 4 }}>INVENTORY TRACKER</div>
            ...
            <div>
              <div style={{ color: s.sky, fontFamily: "'Space Grotesk', sans-serif", fontSize: 12, fontWeight: 700, marginBottom: 4 }}>SUPPORT DASHBOARD</div>
          ...
          <h2 style={{ fontFamily: "'Sora', sans-serif", fontSize: 22, fontWeight: 800, letterSpacing: '-0.03em', color: s.text, margin: '36px 0 14px' }}>From prompt to production in one session</h2>
          ...
          <h2 style={{ fontFamily: "'Sora', sans-serif", fontSize: 22, fontWeight: 800, letterSpacing: '-0.03em', color: s.text, margin: '36px 0 14px' }}>Why this is better than Retool or Appsmith</h2>
          ...
          <h2 style={{ fontFamily: "'Sora', sans-serif", fontSize: 22, fontWeight: 800, letterSpacing: '-0.03em', color: s.text, margin: '36px 0 14px' }}>Start with the tool your team actually needs</h2>
