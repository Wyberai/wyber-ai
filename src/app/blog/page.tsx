...
const POSTS = [
  { slug: 'build-saas-without-code', title: 'How to build a SaaS app without writing code in 2026', excerpt: 'AI app builders have changed what is possible for solo founders. Here is how to go from idea to live product in a single afternoon.', date: 'May 28, 2026', readTime: '6 min read', tag: 'Guide', tagColor: '#0EA5E9' },
  ...
  { slug: 'nextjs-app-in-one-hour', title: 'Build a production Next.js app in under an hour with AI', excerpt: 'Next.js is the default framework in Wyber AI. SSR, SEO, and performance out of the box. A step-by-step walkthrough.', date: 'May 26, 2026', readTime: '5 min read', tag: 'Tutorial', tagColor: '#059669' },
];
              ...
              <div className="wy-card" style={{ padding: '24px 28px', display: 'grid', gridTemplateColumns: '1fr auto', gap: 24, alignItems: 'center' }}>
                <div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 10 }}>
                    ...
                    <span style={{ fontSize: 12, color: 'var(--text3)' }}>{post.date} · {post.readTime}</span>
                  </div>
