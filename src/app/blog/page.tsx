...
export const metadata: Metadata = {
  title: 'Blog — Wyber AI',
  description: 'Tips, guides, and updates from the Wyber AI team. Learn how to build full-stack apps faster with AI.',
};
...
const POSTS = [
  {
    ...
    excerpt: 'AI app builders have changed what\'s possible for solo founders. Here\'s how to go from idea to live product in a single afternoon using Wyber AI.',
    date: 'May 28, 2026',
    readTime: '6 min read',
    tag: 'Guide',
    tagColor: '#0EA5E9',
  },
  {
    ...
    title: 'Wyber AI vs Lovable: Which AI app builder is right for you?',
    excerpt: 'Both tools let you build full-stack apps from plain English. But they make different tradeoffs. Here\'s an honest comparison for developers and founders.',
    date: 'May 27, 2026',
    readTime: '8 min read',
    tag: 'Comparison',
    tagColor: '#7C3AED',
  },
  {
    ...
    excerpt: 'Next.js is the default framework in Wyber AI for a reason — SSR, SEO, and performance out of the box. Here\'s a step-by-step walkthrough.',
    date: 'May 26, 2026',
    readTime: '5 min read',
    tag: 'Tutorial',
    tagColor: '#059669',
            ...
            <Link key={post.slug} href={`/blog/${post.slug}`} style={{ textDecoration: 'none' }}>
              <div className="wy-card" style={{ padding: '24px 28px', display: 'grid', gridTemplateColumns: '1fr auto', gap: 24, alignItems: 'center' }}>
                <div>
                  ...
                  <h2 style={{ fontSize: 18, fontWeight: 700, color: 'var(--text)', letterSpacing: '-0.02em', marginBottom: 8, lineHeight: 1.3 }}>{post.title}</h2>
                  <p style={{ fontSize: 14, color: 'var(--text2)', lineHeight: 1.6, margin: 0 }}>{post.excerpt}</p>
                </div>
                <div style={{ fontSize: 20, color: 'var(--text3)', flexShrink: 0 }}>→</div>
              </div>
            </Link>
          ))}
        </div>
