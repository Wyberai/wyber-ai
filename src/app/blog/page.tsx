...
const POSTS = [
  ...
  { slug: 'nextjs-app-in-one-hour', title: 'Build a production Next.js app in under an hour with AI', excerpt: 'Next.js is the default framework in Wyber AI â€” SSR, SEO, and performance out of the box. A step-by-step walkthrough.', date: 'May 26, 2026', readTime: '5 min read', tag: 'Tutorial', tagColor: '#059669' },
];
              ...
              <div className="wy-card" style={{ padding: '24px 28px', display: 'grid', gridTemplateColumns: '1fr auto', gap: 24, alignItems: 'center' }}>
                <div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 10 }}>
                    ...
                    <span style={{ fontSize: 12, color: 'var(--text3)' }}>{post.date} Â· {post.readTime}</span>
                  </div>
                ...
                <div style={{ fontSize: 18, color: 'var(--text3)', flexShrink: 0 }}>â†’</div>
              </div>
            </Link>
          ))}
        </div>
