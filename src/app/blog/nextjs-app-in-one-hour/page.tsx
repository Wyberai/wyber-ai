    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg)', fontFamily: 'var(--font-sans)' }}>
      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: 'clamp(40px,6vw,72px) clamp(16px,4vw,40px)' }}>
        ...
        <div className="wy-prose">
          ...
          <p>Here's how to go from zero to a live production Next.js app in under an hour.</p>

          <h2>Step 1: Write a specific prompt (5 minutes)</h2>
          <p>The quality of your output is directly proportional to the specificity of your prompt. Don't say "build a landing page." Instead:</p>
          ...
          <p>The more details you include — colors, copy, structure, user roles — the closer the first generation will be to what you want.</p>
          ...
          <p>Go to the Connect tab and add Supabase — full Postgres database, auth, and file storage. Then prompt:</p>
          <div style={{ padding: '14px 18px', borderRadius: 10, background: 'var(--bg2)', border: '1px solid var(--border)', fontFamily: 'var(--font-mono)', fontSize: 13, color: 'var(--text)', lineHeight: 1.7, margin: '16px 0' }}>
            "Add email/password auth using Supabase. After login, redirect to /dashboard."
          </div>

          <h2>Step 4: Publish (5 minutes)</h2>
          <p>Click Publish. Get a live URL at yourapp.wyberai.app. Share it immediately. When ready, deploy to Vercel from the Deploy tab — one click, zero configuration.</p>
