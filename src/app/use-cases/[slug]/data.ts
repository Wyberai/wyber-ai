...
export const USE_CASES: UseCase[] = [
  {
    ...
    metaTitle: 'Build a Mobile App with AI (No Code) — Wyber AI',
    metaDesc: 'Generate a full React Native + Expo mobile app from plain English in under 60 seconds. Runs on iOS and Android. No coding knowledge needed.',
    pillar: 'mobile',
    ...
    body: [
      'Building a mobile app used to mean hiring an iOS developer, an Android developer, and waiting months for a first build. Wyber AI changes that entirely.',
      'Describe your app in plain English — screens, features, data — and Wyber AI generates a complete React Native + Expo project: navigation, components, realistic data, and styling. Scan the QR code to preview on your actual phone, with no Xcode or Android Studio required.',
    ],
    features: [
    ...
    faqs: [
      { q: 'Do I need to know how to code?', a: 'No. You describe your app in plain English and Wyber AI generates all the code. You can preview on your phone without touching a single file.' },
      { q: 'What tech stack does Wyber AI use for mobile?', a: 'Wyber AI generates React Native projects using Expo SDK 52. This is the industry-standard stack used by companies like Shopify, Discord, and Meta.' },
      ...
      { q: 'How long does it take to generate a mobile app?', a: 'Most apps generate in under 60 seconds. Complex multi-screen apps may take 90–120 seconds. You see the code streaming in real time.' },
      { q: 'Can I add more screens after the initial generation?', a: 'Yes. Just describe the new screen in chat: "Add a Settings screen with a profile editor and notification toggles." Wyber AI adds it with full navigation wiring.' },
    ],
  },
  {
    slug: 'ai-agent-builder-no-code',
    h1: 'AI Agent Builder — No Code Required',
    metaTitle: 'AI Agent Builder No-Code — Build Autonomous Agents | Wyber AI',
    ...
    pillarColor: '#10b981',
    tagline: 'Describe what you want the agent to watch and do. Wyber AI builds the canvas, picks the tools, and runs it automatically.',
    body: [
      ...
      'Wyber AI\'s agent builder lets you describe an agent in plain English and generates the full visual canvas: trigger node, tool nodes, AI reasoning nodes, and action nodes. Connect your apps once, and the agent runs on your schedule.',
    ],
    features: [
      ...
      { title: 'Cron + webhook triggers', desc: 'Run agents on a schedule (every morning at 8 AM), on a webhook (when a new lead submits), or manually.' },
    ...
    promptExample: 'Build an agent that runs every morning at 8 AM, checks my Gmail for emails from investors or enterprise prospects, summarizes each one with key action items, and sends me a Slack DM with the summary.',
    ctaLabel: 'Build my agent free',
    ctaHref: '/dashboard?new=agent',
    faqs: [
      { q: 'Do I need to know how to code to build an agent?', a: 'No. You describe the agent\'s job in plain English and Wyber AI generates the node canvas. You connect your tools once in Settings → Integrations.' },
      { q: 'What tools can agents connect to?', a: 'Wyber AI uses Composio for integrations — covering Gmail, Outlook, Slack, HubSpot, Salesforce, Airtable, GitHub, Linear, Stripe, Notion, Google Calendar, and 240+ more.' },
      { q: 'How do I trigger an agent?', a: 'You can trigger agents on a cron schedule (e.g. every day at 9 AM), via a webhook (e.g. when a new Typeform submission arrives), or manually from the dashboard.' },
  ...
  },
  {
    ...
    metaTitle: 'Build a SaaS Without Code — AI SaaS Builder | Wyber AI',
    ...
    pillarColor: '#0EA5E9',
    tagline: 'Describe your SaaS. Get auth, database, dashboard, and deploy URL — in under 60 seconds.',
    body: [
      'Launching a SaaS product used to mean months of development, a technical co-founder, and significant upfront investment. Wyber AI changes the economics entirely.',
      'Describe your product in plain English and Wyber AI generates a complete, production-ready React app: authentication flows, a data model, dashboard UI, and all the supporting components. Connect Supabase for a real database and deploy to Vercel in one click. You have a live URL before lunch.',
    ],
    features: [
      { title: 'Complete app from one prompt', desc: 'Every file, every component, every data record — generated in under 60 seconds. No scaffolding, no boilerplate.' },
    ...
    faqs: [
      { q: 'Can I really build a full SaaS without coding?', a: 'Yes. Wyber AI generates all the frontend code, connects to a real Supabase database (with auth and RLS), and deploys to a live URL. You describe it; we build it.' },
  ...
  },
  {
    ...
    metaTitle: 'AI Workflow Automation Builder No-Code | Wyber AI',
    ...
    pillarColor: '#f59e0b',
    tagline: 'Describe "when X happens, do Y." Wyber AI builds the automation and runs it for you.',
    body: [
      'Workflow automation used to mean learning Zapier, Make, or n8n — platforms with steep learning curves and limited AI capabilities. Wyber AI\'s workflow builder works differently: describe what you want in plain English and it generates the full automation.',
    ...
    features: [
      { title: 'Plain-English workflow creation', desc: 'Describe your automation in a sentence: Wyber AI generates the trigger, action nodes, and data mappings between them.' },
      ...
      { title: 'Trigger on schedule or webhook', desc: 'Activate workflows on a cron schedule, on an incoming webhook, or manually for testing.' },
    ],
    ...
    faqs: [
      { q: 'How is Wyber AI different from Zapier or Make?', a: 'Zapier and Make require you to build automations step by step using their interfaces. Wyber AI lets you describe the workflow in plain English and generates the full automation. It also has native AI reasoning nodes — not just pass-through OpenAI calls.' },
      { q: 'What apps can workflows connect to?', a: 'Wyber AI supports 250+ integrations including Gmail, Slack, HubSpot, Salesforce, Airtable, Notion, GitHub, Linear, Stripe, Google Calendar, and many more.' },
      ...
      { q: 'How do I trigger a workflow automatically?', a: 'Workflows support cron schedules (e.g. every day at 9 AM), incoming webhooks (e.g. from Typeform or Stripe), and manual triggers for testing.' },
      { q: 'Do I need to manage API keys for each integration?', a: 'No. Wyber AI uses Composio for integrations. You authenticate each app once in Settings → Integrations and all your workflows can use it.' },
    ],
  },
  {
    slug: 'no-code-web-app-builder',
    h1: 'No-Code Web App Builder — Ship a Full-Stack App Today',
    metaTitle: 'No-Code Web App Builder — AI-Powered | Wyber AI',
    ...
    body: [
      'Most "no-code" tools build one part of an app. Wyber AI builds the whole thing: UI, routing, state management, a connected database, authentication, and a deployment URL — all from a plain English description.',
      'Whether you\'re building an internal tool, a customer-facing dashboard, or a full SaaS product, Wyber AI generates production-ready React code that you can use as-is or customize with a developer later.',
    ],
    features: [
      { title: 'Complete app — not components', desc: 'Other no-code tools generate UI snippets. Wyber AI generates a complete, running application with every file wired together.' },
      { title: '130+ prebuilt app templates', desc: 'Start from a CRM, dashboard, invoice tracker, kanban board, or any of 130+ templates at zero credit cost.' },
    ...
    ctaHref: '/dashboard?new=app',
    faqs: [
      { q: 'What makes Wyber AI different from Webflow or Bubble?', a: 'Webflow and Bubble have visual editors you build in manually. Wyber AI generates the complete app from plain English in seconds. There\'s nothing to drag and drop — you describe it and it\'s built.' },
      { q: 'Is the output real code I can export?', a: 'Yes. Wyber AI outputs clean React + Vite code. Export it anytime and take it to GitHub, a developer, or your own hosting.' },
      { q: 'Can it build apps with a real database?', a: 'Yes. Connect your Supabase project in Settings → Connectors and Wyber AI rewrites the app to use real Postgres with auth and Row Level Security.' },
      ...
      { q: 'Can I use Wyber AI to build an app for a client?', a: 'Yes. Many Wyber users build apps for clients, then export the code and hand it over. You can also deploy directly to the client\'s Vercel account.' },
    ],
  },
  {
    slug: 'ai-app-builder',
    h1: 'AI App Builder — From Idea to Live App in Minutes',
    metaTitle: 'AI App Builder — Web, Mobile, Agents & Workflows | Wyber AI',
    ...
    pillarLabel: 'Web Apps',
    pillarColor: '#0EA5E9',
    tagline: 'The only AI app builder that covers all four pillars: web apps, mobile apps, AI agents, and workflows.',
    body: [
      'Every other AI app builder does one thing. Wyber AI does four: it builds web apps, mobile apps, AI agents, and workflow automations — all from the same workspace, all from plain English.',
    ...
    features: [
      { title: 'Web app builder', desc: 'Full-stack React apps with dashboard UI, data tables, charts, modals, and Supabase database — generated in < 60 seconds.' },
      { title: 'Mobile app builder', desc: 'React Native + Expo apps for iOS and Android. Preview on your phone instantly via QR code.' },
      { title: 'AI agent builder', desc: 'Autonomous agents connected to 250+ tools, running on schedules or webhooks — with AI reasoning built in.' },
      { title: 'Workflow automation', desc: 'Multi-step automations that connect your apps, apply AI logic, and run without supervision.' },
      { title: '130+ prebuilt templates', desc: 'CRM, invoicing, HR, analytics, e-commerce, booking, and 100+ more — all at 0 credits.' },
    ...
    ctaHref: '/dashboard',
    faqs: [
      { q: 'What can Wyber AI build?', a: 'Wyber AI builds web apps (React, full-stack), mobile apps (React Native + Expo), AI agents (autonomous, connected to 250+ tools), and workflow automations — all from plain English.' },
