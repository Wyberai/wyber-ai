...
export const USE_CASES: UseCase[] = [
  ...
  },
  {
    ...
    body: [
      ...
      'Wyber AI\'s agent builder lets you describe an agent in plain English and generates the full visual canvas: trigger node, tool nodes, AI reasoning nodes, and action nodes. Connect your apps once and run the agent manually — scheduled and webhook triggers are coming soon.',
    ],
    features: [
      ...
      { title: 'Manual triggers (cron + webhooks coming soon)', desc: 'Run agents on demand from the dashboard. Scheduled cron and incoming webhook triggers are in active development.' },
    ...
    faqs: [
      ...
      { q: 'How do I trigger an agent?', a: 'Currently you trigger agents manually from the dashboard by clicking Run. Scheduled cron triggers and incoming webhooks are coming soon.' },
  ...
  },
  {
    ...
    features: [
      ...
      { title: 'Manual triggers (schedule + webhook coming soon)', desc: 'Activate workflows manually for testing. Cron schedules and incoming webhook triggers are in active development.' },
    ],
    ...
    faqs: [
      ...
      { q: 'How do I trigger a workflow automatically?', a: 'Currently workflows are triggered manually. Cron schedules and incoming webhooks are coming soon — manual runs are available today for testing and one-off execution.' },
  ...
  },
  {
    ...
    features: [
      ...
      { title: 'AI agent builder', desc: 'Autonomous agents connected to 250+ tools, triggered manually from the dashboard — with AI reasoning built in.' },
