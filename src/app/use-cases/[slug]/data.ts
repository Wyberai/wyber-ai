...
export const USE_CASES: UseCase[] = [
  ...
  },
  {
    ...
    body: [
      ...
      'Wyber AI\'s agent builder lets you describe an agent in plain English and generates the full visual canvas: trigger node, tool nodes, AI reasoning nodes, and action nodes. Connect your apps once, then run the agent manually or set it on a schedule — daily, hourly, or any custom cron expression.',
    ],
    features: [
