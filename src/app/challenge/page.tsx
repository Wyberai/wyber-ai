...
export const metadata: Metadata = {
  title: 'Build Challenge — $500 in Prizes | WyberAi',
  description: 'Build the best app on WyberAi and win up to $200. Free to enter. Deadline: July 13, 2026.',
  openGraph: {
    title: 'WyberAi Build Challenge — $500 in Prizes',
    description: 'Build the best app using AI and win cash prizes. Free to enter, no coding required.',
...
const PRIZES = [
  { place: '1st', amount: '$200', color: '#FFD700', emoji: '🥇' },
  { place: '2nd', amount: '$100', color: '#C0C0C0', emoji: '🥈' },
  { place: '3rd', amount: '$50', color: '#CD7F32', emoji: '🥉' },
  { place: '4th', amount: '$25', color: '#a855f7', emoji: '🏅' },
  { place: '5th', amount: '$25', color: '#a855f7', emoji: '🏅' },
]
...
const RULES = [
  ...
  { icon: '📅', title: 'Deadline: July 13, 2026', desc: 'All entries must be submitted by 11:59 PM UTC on July 13. Winners announced July 15.' },
]
    ...
    <div style={{ minHeight: '100vh', background: '#09090b', color: '#fafafa', fontFamily: "'Space Grotesk', sans-serif" }}>
      ...
      <section style={{ position: 'relative', textAlign: 'center', padding: 'clamp(60px,10vw,120px) clamp(20px,4vw,48px) 60px', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: 700, margin: '0 auto' }}>
          ...
          <p style={{ fontSize: 18, color: '#a1a1aa', lineHeight: 1.6, marginBottom: 32, maxWidth: 540, margin: '0 auto 32px' }}>
            Build the best app using only plain English. No coding required. <strong style={{ color: '#fafafa' }}>$500 in cash prizes.</strong>
          </p>
          ...
          <p style={{ fontSize: 12, color: '#52525b', marginTop: 16 }}>Free to enter · Deadline: July 13, 2026 · Winners announced July 15</p>
        </div>
      </section>

      {/* Prizes */}
      <section style={{ padding: '60px clamp(20px,4vw,48px)', maxWidth: 800, margin: '0 auto' }}>
        <h2 style={{ textAlign: 'center', fontSize: 28, fontWeight: 800, marginBottom: 40, letterSpacing: '-0.03em' }}>Prizes</h2>
        <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
          {PRIZES.map(p => (
      ...
      <section style={{ padding: '80px clamp(20px,4vw,48px)', textAlign: 'center' }}>
        <div style={{ maxWidth: 500, margin: '0 auto', padding: '48px 32px', borderRadius: 20, background: 'linear-gradient(135deg, rgba(168,85,247,0.1), rgba(14,165,233,0.1))', border: '1px solid rgba(168,85,247,0.2)' }}>
          ...
          <p style={{ fontSize: 14, color: '#a1a1aa', marginBottom: 24 }}>Sign up free, describe your app, and publish it. That&apos;s your entry.</p>
